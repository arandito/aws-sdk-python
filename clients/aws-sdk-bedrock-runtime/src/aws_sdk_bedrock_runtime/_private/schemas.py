...
LIST_ASYNC_INVOKES = Schema(
    ...
    shape_type=ShapeType.OPERATION,
    traits=[
        Trait.new(id=ShapeID("smithy.api#paginated"), value={
...
GUARDRAIL_AUTOMATED_REASONING_POLICY_VERSION_ARN = Schema(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningPolicyVersionArn"),
    shape_type=ShapeType.STRING,
    traits=[
        Trait.new(id=ShapeID("smithy.api#length"), value={
                "max": 2048,
            }),
        Trait.new(id=ShapeID("smithy.api#pattern"), value="^arn:aws(-[^:]+)?:bedrock:[a-z0-9-]{1,20}:[0-9]{12}:automated-reasoning-policy/[a-z0-9]{12}(:([1-9][0-9]{0,11}))?$"),
...
GUARDRAIL_AUTOMATED_REASONING_RULE = Schema.collection(
    ...
    members={
        "identifier": {
            "target": AUTOMATED_REASONING_RULE_IDENTIFIER,
        },
...
GUARDRAIL_AUTOMATED_REASONING_RULE_LIST = Schema.collection(
    ...
    members={
        "member": {
            "target": GUARDRAIL_AUTOMATED_REASONING_RULE,
        },
...
GUARDRAIL_AUTOMATED_REASONING_STATEMENT_LOGIC_CONTENT = Schema(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningStatementLogicContent"),
    shape_type=ShapeType.STRING,
    traits=[
        Trait.new(id=ShapeID("smithy.api#length"), value={
                "max": 1000,
...
GUARDRAIL_AUTOMATED_REASONING_STATEMENT_NATURAL_LANGUAGE_CONTENT = Schema(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningStatementNaturalLanguageContent"),
    shape_type=ShapeType.STRING,
    traits=[
        Trait.new(id=ShapeID("smithy.api#length"), value={
                "max": 1000,
...
GUARDRAIL_AUTOMATED_REASONING_STATEMENT = Schema.collection(
    ...
    members={
        "logic": {
            "target": GUARDRAIL_AUTOMATED_REASONING_STATEMENT_LOGIC_CONTENT,
        },
...
GUARDRAIL_AUTOMATED_REASONING_STATEMENT_LIST = Schema.collection(
    ...
    members={
        "member": {
            "target": GUARDRAIL_AUTOMATED_REASONING_STATEMENT,
        },
...
GUARDRAIL_AUTOMATED_REASONING_LOGIC_WARNING_TYPE = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningLogicWarningType"),
    shape_type=ShapeType.ENUM,
    members={
        "ALWAYS_FALSE": {
            "target": UNIT,
...
GUARDRAIL_AUTOMATED_REASONING_LOGIC_WARNING = Schema.collection(
    ...
    members={
        "type": {
            "target": GUARDRAIL_AUTOMATED_REASONING_LOGIC_WARNING_TYPE,
        },

        "premises": {
            "target": GUARDRAIL_AUTOMATED_REASONING_STATEMENT_LIST,
        },
...
GUARDRAIL_AUTOMATED_REASONING_TRANSLATION_CONFIDENCE = Schema(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningTranslationConfidence"),
...
GUARDRAIL_AUTOMATED_REASONING_INPUT_TEXT_REFERENCE = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningInputTextReference"),
...
GUARDRAIL_AUTOMATED_REASONING_INPUT_TEXT_REFERENCE_LIST = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningInputTextReferenceList"),
    shape_type=ShapeType.LIST,
    members={
        "member": {
            "target": GUARDRAIL_AUTOMATED_REASONING_INPUT_TEXT_REFERENCE,
        },
...
GUARDRAIL_AUTOMATED_REASONING_TRANSLATION = Schema.collection(
    ...
    members={
        ...
        "confidence": {
            "target": GUARDRAIL_AUTOMATED_REASONING_TRANSLATION_CONFIDENCE,
        },
...
GUARDRAIL_AUTOMATED_REASONING_IMPOSSIBLE_FINDING = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningImpossibleFinding"),

    members={
        "translation": {
            "target": GUARDRAIL_AUTOMATED_REASONING_TRANSLATION,
        },

        "contradictingRules": {
            "target": GUARDRAIL_AUTOMATED_REASONING_RULE_LIST,
        },

        "logicWarning": {
            "target": GUARDRAIL_AUTOMATED_REASONING_LOGIC_WARNING,
        },
...
GUARDRAIL_AUTOMATED_REASONING_INVALID_FINDING = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningInvalidFinding"),
...
GUARDRAIL_AUTOMATED_REASONING_NO_TRANSLATIONS_FINDING = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningNoTranslationsFinding"),
...
GUARDRAIL_AUTOMATED_REASONING_SATISFIABLE_FINDING = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningSatisfiableFinding"),
    ...
    members={
        ...
        "claimsTrueScenario": {
            "target": GUARDRAIL_AUTOMATED_REASONING_SCENARIO,
        },
...
GUARDRAIL_AUTOMATED_REASONING_TOO_COMPLEX_FINDING = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningTooComplexFinding"),

)

GUARDRAIL_AUTOMATED_REASONING_DIFFERENCE_SCENARIO_LIST = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningDifferenceScenarioList"),
    shape_type=ShapeType.LIST,
    traits=[
        Trait.new(id=ShapeID("smithy.api#length"), value={
                "max": 2,
...
GUARDRAIL_AUTOMATED_REASONING_TRANSLATION_LIST = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningTranslationList"),
    shape_type=ShapeType.LIST,
    members={
        "member": {
            "target": GUARDRAIL_AUTOMATED_REASONING_TRANSLATION,
...
GUARDRAIL_AUTOMATED_REASONING_TRANSLATION_OPTION = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningTranslationOption"),

    members={
        "translations": {
            "target": GUARDRAIL_AUTOMATED_REASONING_TRANSLATION_LIST,
        },
...
GUARDRAIL_AUTOMATED_REASONING_TRANSLATION_OPTION_LIST = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningTranslationOptionList"),
    shape_type=ShapeType.LIST,
    traits=[
        Trait.new(id=ShapeID("smithy.api#length"), value={
                "max": 2,
    ...
    members={
        "member": {
            "target": GUARDRAIL_AUTOMATED_REASONING_TRANSLATION_OPTION,
        },
...
GUARDRAIL_AUTOMATED_REASONING_TRANSLATION_AMBIGUOUS_FINDING = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningTranslationAmbiguousFinding"),

    members={
        "options": {
            "target": GUARDRAIL_AUTOMATED_REASONING_TRANSLATION_OPTION_LIST,
        },
...
GUARDRAIL_AUTOMATED_REASONING_FINDING = Schema.collection(
    ...
    members={
        "valid": {
            "target": GUARDRAIL_AUTOMATED_REASONING_VALID_FINDING,
        },

        "invalid": {
            "target": GUARDRAIL_AUTOMATED_REASONING_INVALID_FINDING,
        },

        "satisfiable": {
            "target": GUARDRAIL_AUTOMATED_REASONING_SATISFIABLE_FINDING,
        },

        "impossible": {
            "target": GUARDRAIL_AUTOMATED_REASONING_IMPOSSIBLE_FINDING,
        },
        ...
        "tooComplex": {
            "target": GUARDRAIL_AUTOMATED_REASONING_TOO_COMPLEX_FINDING,
        },
...
GUARDRAIL_AUTOMATED_REASONING_FINDING_LIST = Schema.collection(
    ...
    members={
        "member": {
            "target": GUARDRAIL_AUTOMATED_REASONING_FINDING,
        },
...
GUARDRAIL_AUTOMATED_REASONING_POLICY_ASSESSMENT = Schema.collection(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningPolicyAssessment"),

    members={
        "findings": {
            "target": GUARDRAIL_AUTOMATED_REASONING_FINDING_LIST,
        },
...
GUARDRAIL_AUTOMATED_REASONING_POLICIES_PROCESSED = Schema(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningPoliciesProcessed"),
    shape_type=ShapeType.INTEGER,
    traits=[
        Trait.new(id=ShapeID("smithy.api#box")),
...
GUARDRAIL_AUTOMATED_REASONING_POLICY_UNITS_PROCESSED = Schema(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailAutomatedReasoningPolicyUnitsProcessed"),
    shape_type=ShapeType.INTEGER,
    traits=[
        Trait.new(id=ShapeID("smithy.api#box")),
...
GUARDRAIL_CONTENT_POLICY_IMAGE_UNITS_PROCESSED = Schema(
    id=ShapeID("com.amazonaws.bedrockruntime#GuardrailContentPolicyImageUnitsProcessed"),
    shape_type=ShapeType.INTEGER,
    traits=[
        Trait.new(id=ShapeID("smithy.api#box")),
...
CITATION_LOCATION = Schema.collection(
    ...
    members={
        "documentChar": {
            "target": DOCUMENT_CHAR_LOCATION,
        },

        "documentPage": {
            "target": DOCUMENT_PAGE_LOCATION,
        },

        "documentChunk": {
            "target": DOCUMENT_CHUNK_LOCATION,
        },
...
CITATION_SOURCE_CONTENT_LIST = Schema.collection(
    ...
    members={
        "member": {
            "target": CITATION_SOURCE_CONTENT,
        },
...
CITATION = Schema.collection(
    ...
    members={
        ...
        "sourceContent": {
            "target": CITATION_SOURCE_CONTENT_LIST,
        },

        "location": {
            "target": CITATION_LOCATION,
        },
...
CITATION_GENERATED_CONTENT_LIST = Schema.collection(
    ...
    members={
        "member": {
            "target": CITATION_GENERATED_CONTENT,
        },
...
CITATIONS_CONTENT_BLOCK = Schema.collection(
    ...
    members={
        "content": {
            "target": CITATION_GENERATED_CONTENT_LIST,
        },
...
DOCUMENT_SOURCE = Schema.collection(
    ...
    members={
        ...
        "content": {
            "target": DOCUMENT_CONTENT_BLOCKS,
        },
...
CONTENT_BLOCK = Schema.collection(
    ...
    members={
        ...
        "citationsContent": {
            "target": CITATIONS_CONTENT_BLOCK,
        },
...
CITATION_SOURCE_CONTENT_LIST_DELTA = Schema.collection(
    ...
    members={
        "member": {
            "target": CITATION_SOURCE_CONTENT_DELTA,
        },
...
CITATIONS_DELTA = Schema.collection(
    ...
    members={
        ...
        "sourceContent": {
            "target": CITATION_SOURCE_CONTENT_LIST_DELTA,
        },
...
COUNT_TOKENS_INPUT = Schema.collection(
    ...
    members={
        "invokeModel": {
            "target": INVOKE_MODEL_TOKENS_REQUEST,
        },

        "converse": {
            "target": CONVERSE_TOKENS_REQUEST,
        },
...
COUNT_TOKENS_OPERATION_INPUT = Schema.collection(
    ...
    traits=[
        Trait.new(id=ShapeID("smithy.synthetic#originalShapeId"), value="com.amazonaws.bedrockruntime#CountTokensRequest"),
        Trait.new(id=ShapeID("smithy.api#input")),
...
COUNT_TOKENS_OUTPUT = Schema.collection(
    ...
    traits=[
        Trait.new(id=ShapeID("smithy.synthetic#originalShapeId"), value="com.amazonaws.bedrockruntime#CountTokensResponse"),
        Trait.new(id=ShapeID("smithy.api#output")),
