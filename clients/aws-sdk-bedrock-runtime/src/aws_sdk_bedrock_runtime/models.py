...
from ._private.schemas import (
    ...
    APPLIED_GUARDRAIL_DETAILS as _SCHEMA_APPLIED_GUARDRAIL_DETAILS,
    ...
    GUARDRAIL_CHECKS_CONFIG as _SCHEMA_GUARDRAIL_CHECKS_CONFIG,
    GUARDRAIL_CHECKS_CONTENT_BLOCK as _SCHEMA_GUARDRAIL_CHECKS_CONTENT_BLOCK,
    GUARDRAIL_CHECKS_CONTENT_FILTER_CATEGORY_CONFIG as _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_CATEGORY_CONFIG,
    GUARDRAIL_CHECKS_CONTENT_FILTER_CONFIG as _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_CONFIG,
    GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT as _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT,
    GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT_ENTRY as _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT_ENTRY,
    GUARDRAIL_CHECKS_CONTENT_FILTER_USAGE as _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_USAGE,
    GUARDRAIL_CHECKS_MESSAGE as _SCHEMA_GUARDRAIL_CHECKS_MESSAGE,
    GUARDRAIL_CHECKS_PROMPT_ATTACK_CATEGORY_CONFIG as _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_CATEGORY_CONFIG,
    GUARDRAIL_CHECKS_PROMPT_ATTACK_CONFIG as _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_CONFIG,
    GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT as _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT,
    GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT_ENTRY as _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT_ENTRY,
    GUARDRAIL_CHECKS_PROMPT_ATTACK_USAGE as _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_USAGE,
    GUARDRAIL_CHECKS_RESULTS as _SCHEMA_GUARDRAIL_CHECKS_RESULTS,
    GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_CONFIG as _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_CONFIG,
    GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_ENTITY_CONFIG as _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_ENTITY_CONFIG,
    GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT as _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT,
    GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY as _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY,
    GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_USAGE as _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_USAGE,
    GUARDRAIL_CHECKS_USAGE_RESULTS as _SCHEMA_GUARDRAIL_CHECKS_USAGE_RESULTS,
    ...
    INVOKE_GUARDRAIL_CHECKS as _SCHEMA_INVOKE_GUARDRAIL_CHECKS,
    INVOKE_GUARDRAIL_CHECKS_INPUT as _SCHEMA_INVOKE_GUARDRAIL_CHECKS_INPUT,
    INVOKE_GUARDRAIL_CHECKS_OUTPUT as _SCHEMA_INVOKE_GUARDRAIL_CHECKS_OUTPUT,
    ...
    SEARCH_RESULT_BLOCK as _SCHEMA_SEARCH_RESULT_BLOCK,
    SEARCH_RESULT_CONTENT_BLOCK as _SCHEMA_SEARCH_RESULT_CONTENT_BLOCK,
    SEARCH_RESULT_LOCATION as _SCHEMA_SEARCH_RESULT_LOCATION,
    SERVICE_QUOTA_EXCEEDED_EXCEPTION as _SCHEMA_SERVICE_QUOTA_EXCEEDED_EXCEPTION,
    SERVICE_TIER as _SCHEMA_SERVICE_TIER,
    ...
    SYSTEM_TOOL as _SCHEMA_SYSTEM_TOOL,
    TAG as _SCHEMA_TAG,
    ...
    WEB_LOCATION as _SCHEMA_WEB_LOCATION,
)
...
class AsyncInvokeStatus(UnknownEnumMixin, StrEnum):
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 3:
                    kwargs["status"] = AsyncInvokeStatus(
                        de.read_string(
        ...
        if "status" not in kwargs:
            kwargs["status"] = AsyncInvokeStatus._corrected("")
        if "submit_time" not in kwargs:
            kwargs["submit_time"] = datetime.fromtimestamp(0, tz=timezone.utc)
        if "output_data_config" not in kwargs:
            kwargs["output_data_config"] = AsyncInvokeOutputDataConfigUnknown(tag="")
        return kwargs
...
class SortAsyncInvocationBy(UnknownEnumMixin, StrEnum):
    SUBMISSION_TIME = "SubmissionTime"


class SortOrder(UnknownEnumMixin, StrEnum):
    ASCENDING = "Ascending"
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 2:
                    kwargs["status_equals"] = AsyncInvokeStatus(
                        de.read_string(
                            _SCHEMA_LIST_ASYNC_INVOKES_INPUT.members["statusEquals"]
                        )
                    )
                ...
                case 5:
                    kwargs["sort_by"] = SortAsyncInvocationBy(
                        de.read_string(
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 3:
                    kwargs["status"] = AsyncInvokeStatus(
                        de.read_string(_SCHEMA_ASYNC_INVOKE_SUMMARY.members["status"])
                    )
...
class GuardrailImageFormat(UnknownEnumMixin, StrEnum):
    PNG = "png"
    JPEG = "jpeg"
...
class GuardrailImageBlock:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["format"] = GuardrailImageFormat(
                        de.read_string(_SCHEMA_GUARDRAIL_IMAGE_BLOCK.members["format"])
                    )
        ...
        if "format" not in kwargs:
            kwargs["format"] = GuardrailImageFormat._corrected("")
        if "source" not in kwargs:
            kwargs["source"] = GuardrailImageSourceUnknown(tag="")
        return kwargs


class GuardrailContentQualifier(UnknownEnumMixin, StrEnum):
...
def _deserialize_guardrail_content_qualifier_list(
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(GuardrailContentQualifier(d.read_string(member_schema)))
...
class GuardrailOutputScope(UnknownEnumMixin, StrEnum):
    INTERVENTIONS = "INTERVENTIONS"
    FULL = "FULL"


class GuardrailContentSource(UnknownEnumMixin, StrEnum):
    INPUT = "INPUT"
    OUTPUT = "OUTPUT"
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 2:
                    kwargs["source"] = GuardrailContentSource(
                        de.read_string(_SCHEMA_APPLY_GUARDRAIL_INPUT.members["source"])
                    )
                ...
                case 4:
                    kwargs["output_scope"] = GuardrailOutputScope(
                        de.read_string(
...
class GuardrailAction(UnknownEnumMixin, StrEnum):
    NONE = "NONE"
    GUARDRAIL_INTERVENED = "GUARDRAIL_INTERVENED"


class GuardrailOrigin(UnknownEnumMixin, StrEnum):
    REQUEST = "REQUEST"
...
def _deserialize_guardrail_origin_list(
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(GuardrailOrigin(d.read_string(member_schema)))

    deserializer.read_list(schema, _read_value)
    return result


class GuardrailOwnership(UnknownEnumMixin, StrEnum):
    SELF = "SELF"
...
class AppliedGuardrailDetails:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_APPLIED_GUARDRAIL_DETAILS, self)

    def serialize_members(self, serializer: ShapeSerializer):
        if self.guardrail_id is not None:
            serializer.write_string(
                _SCHEMA_APPLIED_GUARDRAIL_DETAILS.members["guardrailId"],
                self.guardrail_id,
            )

        if self.guardrail_version is not None:
            serializer.write_string(
                _SCHEMA_APPLIED_GUARDRAIL_DETAILS.members["guardrailVersion"],
                self.guardrail_version,
            )

        if self.guardrail_arn is not None:
            serializer.write_string(
                _SCHEMA_APPLIED_GUARDRAIL_DETAILS.members["guardrailArn"],
                self.guardrail_arn,
            )

        if self.guardrail_origin is not None:
            _serialize_guardrail_origin_list(
                serializer,
                _SCHEMA_APPLIED_GUARDRAIL_DETAILS.members["guardrailOrigin"],
                self.guardrail_origin,
            )

        if self.guardrail_ownership is not None:
            serializer.write_string(
                _SCHEMA_APPLIED_GUARDRAIL_DETAILS.members["guardrailOwnership"],
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["guardrail_id"] = de.read_string(
                        _SCHEMA_APPLIED_GUARDRAIL_DETAILS.members["guardrailId"]
                    )
                ...
                case 2:
                    kwargs["guardrail_arn"] = de.read_string(
                        _SCHEMA_APPLIED_GUARDRAIL_DETAILS.members["guardrailArn"]
                    )

                case 3:
                    kwargs["guardrail_origin"] = _deserialize_guardrail_origin_list(
                        de, _SCHEMA_APPLIED_GUARDRAIL_DETAILS.members["guardrailOrigin"]
                    )

                case 4:
                    kwargs["guardrail_ownership"] = GuardrailOwnership(
                        de.read_string(
                            _SCHEMA_APPLIED_GUARDRAIL_DETAILS.members[
                                "guardrailOwnership"
                            ]
                        )
                    )
        ...
        deserializer.read_struct(_SCHEMA_APPLIED_GUARDRAIL_DETAILS, consumer=_consumer)
        return kwargs
...
class GuardrailAutomatedReasoningLogicWarningType(UnknownEnumMixin, StrEnum):
...
class GuardrailAutomatedReasoningLogicWarning:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["type"] = GuardrailAutomatedReasoningLogicWarningType(
                        de.read_string(
...
class GuardrailContentPolicyAction(UnknownEnumMixin, StrEnum):
    BLOCKED = "BLOCKED"
    NONE = "NONE"


class GuardrailContentFilterConfidence(UnknownEnumMixin, StrEnum):
    NONE = "NONE"
    LOW = "LOW"
    MEDIUM = "MEDIUM"
    HIGH = "HIGH"
...
class GuardrailContentFilterStrength(UnknownEnumMixin, StrEnum):
    NONE = "NONE"
    LOW = "LOW"
    MEDIUM = "MEDIUM"
    HIGH = "HIGH"
...
class GuardrailContentFilterType(UnknownEnumMixin, StrEnum):
    INSULTS = "INSULTS"
    HATE = "HATE"
    SEXUAL = "SEXUAL"
    VIOLENCE = "VIOLENCE"
...
class GuardrailContentFilter:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["type"] = GuardrailContentFilterType(
                        de.read_string(_SCHEMA_GUARDRAIL_CONTENT_FILTER.members["type"])
                    )

                case 1:
                    kwargs["confidence"] = GuardrailContentFilterConfidence(
                        de.read_string(
                ...
                case 2:
                    kwargs["filter_strength"] = GuardrailContentFilterStrength(
                        de.read_string(
                            _SCHEMA_GUARDRAIL_CONTENT_FILTER.members["filterStrength"]
                        )
                    )
                ...
                case 3:
                    kwargs["action"] = GuardrailContentPolicyAction(
                        de.read_string(
        ...
        if "type" not in kwargs:
            kwargs["type"] = GuardrailContentFilterType._corrected("")
        if "confidence" not in kwargs:
            kwargs["confidence"] = GuardrailContentFilterConfidence._corrected("")
        if "action" not in kwargs:
            kwargs["action"] = GuardrailContentPolicyAction._corrected("")
        return kwargs
...
class GuardrailContextualGroundingPolicyAction(UnknownEnumMixin, StrEnum):
    BLOCKED = "BLOCKED"
    NONE = "NONE"


class GuardrailContextualGroundingFilterType(UnknownEnumMixin, StrEnum):
    GROUNDING = "GROUNDING"
    RELEVANCE = "RELEVANCE"
...
class GuardrailContextualGroundingFilter:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["type"] = GuardrailContextualGroundingFilterType(
                        de.read_string(
                ...
                case 3:
                    kwargs["action"] = GuardrailContextualGroundingPolicyAction(
                        de.read_string(
                            _SCHEMA_GUARDRAIL_CONTEXTUAL_GROUNDING_FILTER.members[
                                "action"
                            ]
        ...
        if "type" not in kwargs:
            kwargs["type"] = GuardrailContextualGroundingFilterType._corrected("")
        if "threshold" not in kwargs:
            kwargs["threshold"] = 0.0
        if "score" not in kwargs:
            kwargs["score"] = 0.0
        if "action" not in kwargs:
            kwargs["action"] = GuardrailContextualGroundingPolicyAction._corrected("")
        return kwargs
...
class GuardrailUsage:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        if "topic_policy_units" not in kwargs:
            kwargs["topic_policy_units"] = 0
        if "content_policy_units" not in kwargs:
            kwargs["content_policy_units"] = 0
        if "word_policy_units" not in kwargs:
            kwargs["word_policy_units"] = 0
        if "sensitive_information_policy_units" not in kwargs:
            kwargs["sensitive_information_policy_units"] = 0
        if "sensitive_information_policy_free_units" not in kwargs:
            kwargs["sensitive_information_policy_free_units"] = 0
        if "contextual_grounding_policy_units" not in kwargs:
            kwargs["contextual_grounding_policy_units"] = 0
        return kwargs
...
class GuardrailSensitiveInformationPolicyAction(UnknownEnumMixin, StrEnum):
    ANONYMIZED = "ANONYMIZED"
    BLOCKED = "BLOCKED"
    NONE = "NONE"


class GuardrailPiiEntityType(UnknownEnumMixin, StrEnum):
    ADDRESS = "ADDRESS"
    AGE = "AGE"
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 1:
                    kwargs["type"] = GuardrailPiiEntityType(
                        de.read_string(
                ...
                case 2:
                    kwargs["action"] = GuardrailSensitiveInformationPolicyAction(
                        de.read_string(
        ...
        if "match" not in kwargs:
            kwargs["match"] = ""
        if "type" not in kwargs:
            kwargs["type"] = GuardrailPiiEntityType._corrected("")
        if "action" not in kwargs:
            kwargs["action"] = GuardrailSensitiveInformationPolicyAction._corrected("")
        return kwargs
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 3:
                    kwargs["action"] = GuardrailSensitiveInformationPolicyAction(
                        de.read_string(_SCHEMA_GUARDRAIL_REGEX_FILTER.members["action"])
                    )
...
class GuardrailSensitiveInformationPolicyAssessment:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        if "pii_entities" not in kwargs:
            kwargs["pii_entities"] = []
        if "regexes" not in kwargs:
            kwargs["regexes"] = []
        return kwargs


class GuardrailTopicPolicyAction(UnknownEnumMixin, StrEnum):
    BLOCKED = "BLOCKED"
    NONE = "NONE"


class GuardrailTopicType(UnknownEnumMixin, StrEnum):
    DENY = "DENY"
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 1:
                    kwargs["type"] = GuardrailTopicType(
                        de.read_string(_SCHEMA_GUARDRAIL_TOPIC.members["type"])
                    )

                case 2:
                    kwargs["action"] = GuardrailTopicPolicyAction(
                        de.read_string(_SCHEMA_GUARDRAIL_TOPIC.members["action"])
                    )
        ...
        if "name" not in kwargs:
            kwargs["name"] = ""
        if "type" not in kwargs:
            kwargs["type"] = GuardrailTopicType._corrected("")
        if "action" not in kwargs:
            kwargs["action"] = GuardrailTopicPolicyAction._corrected("")
        return kwargs
...
class GuardrailWordPolicyAction(UnknownEnumMixin, StrEnum):
    BLOCKED = "BLOCKED"
    NONE = "NONE"
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 1:
                    kwargs["action"] = GuardrailWordPolicyAction(
                        de.read_string(_SCHEMA_GUARDRAIL_CUSTOM_WORD.members["action"])
                    )
        ...
        if "match" not in kwargs:
            kwargs["match"] = ""
        if "action" not in kwargs:
            kwargs["action"] = GuardrailWordPolicyAction._corrected("")
        return kwargs
...
class GuardrailManagedWordType(UnknownEnumMixin, StrEnum):
    PROFANITY = "PROFANITY"
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 1:
                    kwargs["type"] = GuardrailManagedWordType(
                        de.read_string(_SCHEMA_GUARDRAIL_MANAGED_WORD.members["type"])
                    )

                case 2:
                    kwargs["action"] = GuardrailWordPolicyAction(
                        de.read_string(_SCHEMA_GUARDRAIL_MANAGED_WORD.members["action"])
                    )
        ...
        if "match" not in kwargs:
            kwargs["match"] = ""
        if "type" not in kwargs:
            kwargs["type"] = GuardrailManagedWordType._corrected("")
        if "action" not in kwargs:
            kwargs["action"] = GuardrailWordPolicyAction._corrected("")
        return kwargs
...
class GuardrailWordPolicyAssessment:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        if "custom_words" not in kwargs:
            kwargs["custom_words"] = []
        if "managed_word_lists" not in kwargs:
            kwargs["managed_word_lists"] = []
        return kwargs
...
class GuardrailAssessment:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.applied_guardrail_details is not None:
            serializer.write_struct(
                _SCHEMA_GUARDRAIL_ASSESSMENT.members["appliedGuardrailDetails"],
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 7:
                    kwargs["applied_guardrail_details"] = (
                        AppliedGuardrailDetails.deserialize(de)
                    )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 1:
                    kwargs["action"] = GuardrailAction(
                        de.read_string(_SCHEMA_APPLY_GUARDRAIL_OUTPUT.members["action"])
                    )
        ...
        if "usage" not in kwargs:
            kwargs["usage"] = GuardrailUsage._smithy_default()
        if "action" not in kwargs:
            kwargs["action"] = GuardrailAction._corrected("")
        if "outputs" not in kwargs:
            kwargs["outputs"] = []
        if "assessments" not in kwargs:
            kwargs["assessments"] = []
        return kwargs
...
class GuardrailChecksContentFilterCategory(UnknownEnumMixin, StrEnum):
...
class GuardrailChecksContentFilterCategoryConfig:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_CATEGORY_CONFIG, self
        )

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_CATEGORY_CONFIG.members["category"],
            self.category,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["category"] = GuardrailChecksContentFilterCategory(
                        de.read_string(
                            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_CATEGORY_CONFIG.members[
                                "category"
                            ]
                        )
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_CATEGORY_CONFIG, consumer=_consumer
        )
        if "category" not in kwargs:
            kwargs["category"] = GuardrailChecksContentFilterCategory._corrected("")
        return kwargs


def _serialize_guardrail_checks_content_filter_category_config_list(
    serializer: ShapeSerializer,
    schema: Schema,
    value: list[GuardrailChecksContentFilterCategoryConfig],
) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
...
def _deserialize_guardrail_checks_content_filter_category_config_list(
    deserializer: ShapeDeserializer, schema: Schema
) -> list[GuardrailChecksContentFilterCategoryConfig]:
    result: list[GuardrailChecksContentFilterCategoryConfig] = []
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(GuardrailChecksContentFilterCategoryConfig.deserialize(d))
...
class GuardrailChecksContentFilterConfig:
    ...
    categories: list[GuardrailChecksContentFilterCategoryConfig]
    """The content filter categories to evaluate."""

    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_CONFIG, self)

    def serialize_members(self, serializer: ShapeSerializer):
        _serialize_guardrail_checks_content_filter_category_config_list(
            serializer,
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_CONFIG.members["categories"],
            self.categories,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["categories"] = (
                        _deserialize_guardrail_checks_content_filter_category_config_list(
                            de,
                            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_CONFIG.members[
                                "categories"
                            ],
                        )
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_CONFIG, consumer=_consumer
        )
...
class GuardrailChecksPromptAttackCategory(UnknownEnumMixin, StrEnum):
...
class GuardrailChecksPromptAttackCategoryConfig:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_CATEGORY_CONFIG, self
        )

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_CATEGORY_CONFIG.members["category"],
            self.category,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["category"] = GuardrailChecksPromptAttackCategory(
                        de.read_string(
                            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_CATEGORY_CONFIG.members[
                                "category"
                            ]
                        )
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_CATEGORY_CONFIG, consumer=_consumer
        )
        if "category" not in kwargs:
            kwargs["category"] = GuardrailChecksPromptAttackCategory._corrected("")
        return kwargs


def _serialize_guardrail_checks_prompt_attack_category_config_list(
    serializer: ShapeSerializer,
    schema: Schema,
    value: list[GuardrailChecksPromptAttackCategoryConfig],
) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
...
def _deserialize_guardrail_checks_prompt_attack_category_config_list(
    deserializer: ShapeDeserializer, schema: Schema
) -> list[GuardrailChecksPromptAttackCategoryConfig]:
    result: list[GuardrailChecksPromptAttackCategoryConfig] = []
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(GuardrailChecksPromptAttackCategoryConfig.deserialize(d))
...
class GuardrailChecksPromptAttackConfig:
    ...
    categories: list[GuardrailChecksPromptAttackCategoryConfig]
    """The prompt attack categories to evaluate."""

    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_CONFIG, self)

    def serialize_members(self, serializer: ShapeSerializer):
        _serialize_guardrail_checks_prompt_attack_category_config_list(
            serializer,
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_CONFIG.members["categories"],
            self.categories,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["categories"] = (
                        _deserialize_guardrail_checks_prompt_attack_category_config_list(
                            de,
                            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_CONFIG.members[
                                "categories"
                            ],
                        )
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_CONFIG, consumer=_consumer
        )
        if "categories" not in kwargs:
            kwargs["categories"] = []
        return kwargs
...
class GuardrailChecksSensitiveInformationEntityType(UnknownEnumMixin, StrEnum):
...
class GuardrailChecksSensitiveInformationEntityConfig:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_ENTITY_CONFIG, self
        )

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_ENTITY_CONFIG.members[
                "type"
            ],
            self.type,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["type"] = GuardrailChecksSensitiveInformationEntityType(
                        de.read_string(
                            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_ENTITY_CONFIG.members[
                                "type"
                            ]
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_ENTITY_CONFIG,
            consumer=_consumer,
        )
        if "type" not in kwargs:
            kwargs["type"] = GuardrailChecksSensitiveInformationEntityType._corrected(
                ""
            )
        return kwargs


def _serialize_guardrail_checks_sensitive_information_entity_config_list(
    serializer: ShapeSerializer,
    schema: Schema,
    value: list[GuardrailChecksSensitiveInformationEntityConfig],
) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
...
def _deserialize_guardrail_checks_sensitive_information_entity_config_list(
    deserializer: ShapeDeserializer, schema: Schema
) -> list[GuardrailChecksSensitiveInformationEntityConfig]:
    result: list[GuardrailChecksSensitiveInformationEntityConfig] = []
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(
                GuardrailChecksSensitiveInformationEntityConfig.deserialize(d)
            )
...
class GuardrailChecksSensitiveInformationConfig:
    ...
    entities: list[GuardrailChecksSensitiveInformationEntityConfig]
    """The sensitive information entity types to detect."""

    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_CONFIG, self
        )

    def serialize_members(self, serializer: ShapeSerializer):
        _serialize_guardrail_checks_sensitive_information_entity_config_list(
            serializer,
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_CONFIG.members["entities"],
            self.entities,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["entities"] = (
                        _deserialize_guardrail_checks_sensitive_information_entity_config_list(
                            de,
                            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_CONFIG.members[
                                "entities"
                            ],
                        )
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_CONFIG, consumer=_consumer
        )
...
class GuardrailChecksConfig:
    ...
    content_filter: GuardrailChecksContentFilterConfig | None = None
    """The content filter check configuration."""

    prompt_attack: GuardrailChecksPromptAttackConfig | None = None
    """The prompt attack check configuration."""

    sensitive_information: GuardrailChecksSensitiveInformationConfig | None = None
    """The sensitive information check configuration."""

    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_CONFIG, self)

    def serialize_members(self, serializer: ShapeSerializer):
        if self.content_filter is not None:
            serializer.write_struct(
                _SCHEMA_GUARDRAIL_CHECKS_CONFIG.members["contentFilter"],
                self.content_filter,
            )

        if self.prompt_attack is not None:
            serializer.write_struct(
                _SCHEMA_GUARDRAIL_CHECKS_CONFIG.members["promptAttack"],
                self.prompt_attack,
            )

        if self.sensitive_information is not None:
            serializer.write_struct(
                _SCHEMA_GUARDRAIL_CHECKS_CONFIG.members["sensitiveInformation"],
            ...
            match schema.expect_member_index():
                case 0:
                    kwargs["content_filter"] = (
                        GuardrailChecksContentFilterConfig.deserialize(de)
                    )

                case 1:
                    kwargs["prompt_attack"] = (
                        GuardrailChecksPromptAttackConfig.deserialize(de)
                    )

                case 2:
                    kwargs["sensitive_information"] = (
                        GuardrailChecksSensitiveInformationConfig.deserialize(de)
                    )

                case _:
                    logger.debug("Unexpected member schema: %s", schema)

        deserializer.read_struct(_SCHEMA_GUARDRAIL_CHECKS_CONFIG, consumer=_consumer)
        return kwargs


@dataclass
class GuardrailChecksContentBlockText:
    """The text content to evaluate."""

    value: str

    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_CONTENT_BLOCK, self)

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_BLOCK.members["text"], self.value
        )
    ...
    def deserialize(cls, deserializer: ShapeDeserializer) -> Self:
        return cls(
            value=deserializer.read_string(
                _SCHEMA_GUARDRAIL_CHECKS_CONTENT_BLOCK.members["text"]
            )
        )


@dataclass
class GuardrailChecksContentBlockUnknown:
    """
    Represents an unknown variant.
...
GuardrailChecksContentBlock = Union[
    GuardrailChecksContentBlockText | GuardrailChecksContentBlockUnknown
]
"""A content block within a message to evaluate."""


class _GuardrailChecksContentBlockDeserializer:
    _result: GuardrailChecksContentBlock | None = None

    def deserialize(
        self, deserializer: ShapeDeserializer
    ) -> GuardrailChecksContentBlock:
        self._result = None
        deserializer.read_struct(_SCHEMA_GUARDRAIL_CHECKS_CONTENT_BLOCK, self._consumer)
    ...
    def _consumer(self, schema: Schema, de: ShapeDeserializer) -> None:
        match schema.expect_member_index():
            case 0:
                self._set_result(GuardrailChecksContentBlockText.deserialize(de))

            case _:
                self._set_result(
                    GuardrailChecksContentBlockUnknown(tag=schema.expect_member_name())
                )

    def _set_result(self, value: GuardrailChecksContentBlock) -> None:
        if self._result is not None:
            raise SerializationError(
                "Unions must have exactly one value, but found more than one."
            )
...
def _serialize_guardrail_checks_content_block_list(
    serializer: ShapeSerializer,
    schema: Schema,
    value: list[GuardrailChecksContentBlock],
) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
...
def _deserialize_guardrail_checks_content_block_list(
    deserializer: ShapeDeserializer, schema: Schema
) -> list[GuardrailChecksContentBlock]:
    result: list[GuardrailChecksContentBlock] = []
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(_GuardrailChecksContentBlockDeserializer().deserialize(d))

    deserializer.read_list(schema, _read_value)
    return result


class GuardrailChecksRole(UnknownEnumMixin, StrEnum):
...
class GuardrailChecksMessage:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_MESSAGE, self)

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(
            _SCHEMA_GUARDRAIL_CHECKS_MESSAGE.members["role"], self.role
        )
        _serialize_guardrail_checks_content_block_list(
            serializer,
            _SCHEMA_GUARDRAIL_CHECKS_MESSAGE.members["content"],
            self.content,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["role"] = GuardrailChecksRole(
                        de.read_string(_SCHEMA_GUARDRAIL_CHECKS_MESSAGE.members["role"])
                    )

                case 1:
                    kwargs["content"] = (
                        _deserialize_guardrail_checks_content_block_list(
                            de, _SCHEMA_GUARDRAIL_CHECKS_MESSAGE.members["content"]
                        )
                    )
        ...
        deserializer.read_struct(_SCHEMA_GUARDRAIL_CHECKS_MESSAGE, consumer=_consumer)
        if "role" not in kwargs:
            kwargs["role"] = GuardrailChecksRole._corrected("")
        if "content" not in kwargs:
            kwargs["content"] = []
        return kwargs


def _serialize_guardrail_checks_message_list(
    serializer: ShapeSerializer, schema: Schema, value: list[GuardrailChecksMessage]
) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
...
def _deserialize_guardrail_checks_message_list(
    deserializer: ShapeDeserializer, schema: Schema
) -> list[GuardrailChecksMessage]:
    result: list[GuardrailChecksMessage] = []
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(GuardrailChecksMessage.deserialize(d))
...
@dataclass(kw_only=True)
class InvokeGuardrailChecksInput:
    """Dataclass for InvokeGuardrailChecksInput structure."""

    messages: list[GuardrailChecksMessage] | None = None
    """
    ...
    checks: GuardrailChecksConfig | None = None
    """
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_INVOKE_GUARDRAIL_CHECKS_INPUT, self)

    def serialize_members(self, serializer: ShapeSerializer):
        if self.messages is not None:
            _serialize_guardrail_checks_message_list(
                serializer,
                _SCHEMA_INVOKE_GUARDRAIL_CHECKS_INPUT.members["messages"],
                self.messages,
            )

        if self.checks is not None:
            serializer.write_struct(
                _SCHEMA_INVOKE_GUARDRAIL_CHECKS_INPUT.members["checks"], self.checks
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["messages"] = _deserialize_guardrail_checks_message_list(
                        de, _SCHEMA_INVOKE_GUARDRAIL_CHECKS_INPUT.members["messages"]
                    )

                case 1:
                    kwargs["checks"] = GuardrailChecksConfig.deserialize(de)

                case _:
                    logger.debug("Unexpected member schema: %s", schema)

        deserializer.read_struct(
            _SCHEMA_INVOKE_GUARDRAIL_CHECKS_INPUT, consumer=_consumer
        )
        return kwargs
...
class GuardrailChecksContentFilterResultEntry:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT_ENTRY, self
        )

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT_ENTRY.members["category"],
            self.category,
        )
        serializer.write_double(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT_ENTRY.members[
                "severityScore"
            ],
            self.severity_score,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 1:
                    kwargs["severity_score"] = de.read_double(
                        _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT_ENTRY.members[
                            "severityScore"
                        ]
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT_ENTRY, consumer=_consumer
        )
        if "category" not in kwargs:
            kwargs["category"] = GuardrailChecksContentFilterCategory._corrected("")
        if "severity_score" not in kwargs:
            kwargs["severity_score"] = 0.0
        return kwargs


def _serialize_guardrail_checks_content_filter_result_list(
    serializer: ShapeSerializer,
    schema: Schema,
    value: list[GuardrailChecksContentFilterResultEntry],
) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
...
def _deserialize_guardrail_checks_content_filter_result_list(
    deserializer: ShapeDeserializer, schema: Schema
) -> list[GuardrailChecksContentFilterResultEntry]:
    result: list[GuardrailChecksContentFilterResultEntry] = []
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(GuardrailChecksContentFilterResultEntry.deserialize(d))
...
class GuardrailChecksContentFilterResult:
    ...
    results: list[GuardrailChecksContentFilterResultEntry]
    """The per-category content filter results."""

    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT, self)

    def serialize_members(self, serializer: ShapeSerializer):
        _serialize_guardrail_checks_content_filter_result_list(
            serializer,
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT.members["results"],
            self.results,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["results"] = (
                        _deserialize_guardrail_checks_content_filter_result_list(
                            de,
                            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT.members[
                                "results"
                            ],
                        )
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_RESULT, consumer=_consumer
        )
...
class GuardrailChecksPromptAttackResultEntry:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT_ENTRY, self
        )

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT_ENTRY.members["category"],
            self.category,
        )
        serializer.write_double(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT_ENTRY.members[
                "severityScore"
            ],
            self.severity_score,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT_ENTRY, consumer=_consumer
        )
        if "category" not in kwargs:
            kwargs["category"] = GuardrailChecksPromptAttackCategory._corrected("")
        if "severity_score" not in kwargs:
...
def _serialize_guardrail_checks_prompt_attack_result_list(
    serializer: ShapeSerializer,
    schema: Schema,
    value: list[GuardrailChecksPromptAttackResultEntry],
) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
...
def _deserialize_guardrail_checks_prompt_attack_result_list(
    deserializer: ShapeDeserializer, schema: Schema
) -> list[GuardrailChecksPromptAttackResultEntry]:
    result: list[GuardrailChecksPromptAttackResultEntry] = []
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(GuardrailChecksPromptAttackResultEntry.deserialize(d))
...
class GuardrailChecksPromptAttackResult:
    ...
    results: list[GuardrailChecksPromptAttackResultEntry]
    """The per-category prompt attack results."""

    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT, self)

    def serialize_members(self, serializer: ShapeSerializer):
        _serialize_guardrail_checks_prompt_attack_result_list(
            serializer,
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT.members["results"],
            self.results,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["results"] = (
                        _deserialize_guardrail_checks_prompt_attack_result_list(
                            de,
                            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT.members[
                                "results"
                            ],
                        )
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_RESULT, consumer=_consumer
        )
        if "results" not in kwargs:
            kwargs["results"] = []
        return kwargs
...
class GuardrailChecksSensitiveInformationResultEntry:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY, self
        )

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY.members["type"],
            self.type,
        )
        serializer.write_double(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY.members[
                "confidenceScore"
            ],
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 1:
                    kwargs["confidence_score"] = de.read_double(
                        _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY.members[
                            "confidenceScore"
                        ]
                    )
                ...
                case 2:
                    kwargs["begin_offset"] = de.read_integer(
                        _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY.members[
                            "beginOffset"
                        ]
                    )
                ...
                case 3:
                    kwargs["end_offset"] = de.read_integer(
                        _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY.members[
                            "endOffset"
                        ]
                    )
                ...
                case 4:
                    kwargs["message_index"] = de.read_integer(
                        _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY.members[
                            "messageIndex"
                        ]
                    )
                ...
                case 5:
                    kwargs["content_index"] = de.read_integer(
                        _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY.members[
                            "contentIndex"
                        ]
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT_ENTRY,
            consumer=_consumer,
        )
        if "type" not in kwargs:
            kwargs["type"] = GuardrailChecksSensitiveInformationEntityType._corrected(
        ...
        if "begin_offset" not in kwargs:
            kwargs["begin_offset"] = 0
        if "end_offset" not in kwargs:
            kwargs["end_offset"] = 0
        if "message_index" not in kwargs:
            kwargs["message_index"] = 0
        if "content_index" not in kwargs:
            kwargs["content_index"] = 0
        return kwargs


def _serialize_guardrail_checks_sensitive_information_result_list(
    serializer: ShapeSerializer,
    schema: Schema,
    value: list[GuardrailChecksSensitiveInformationResultEntry],
) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
...
def _deserialize_guardrail_checks_sensitive_information_result_list(
    deserializer: ShapeDeserializer, schema: Schema
) -> list[GuardrailChecksSensitiveInformationResultEntry]:
    result: list[GuardrailChecksSensitiveInformationResultEntry] = []
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(GuardrailChecksSensitiveInformationResultEntry.deserialize(d))
...
class GuardrailChecksSensitiveInformationResult:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT, self
        )

    def serialize_members(self, serializer: ShapeSerializer):
        _serialize_guardrail_checks_sensitive_information_result_list(
            serializer,
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT.members["results"],
            self.results,
        )
        if self.truncated is not None:
            serializer.write_boolean(
                _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT.members[
                    "truncated"
                ],
                self.truncated,
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["results"] = (
                        _deserialize_guardrail_checks_sensitive_information_result_list(
                            de,
                            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT.members[
                                "results"
                            ],
                ...
                case 1:
                    kwargs["truncated"] = de.read_boolean(
                        _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT.members[
                            "truncated"
                        ]
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_RESULT, consumer=_consumer
        )
        if "results" not in kwargs:
            kwargs["results"] = []
        return kwargs
...
class GuardrailChecksResults:
    ...
    content_filter: GuardrailChecksContentFilterResult | None = None
    """The content filter check results."""

    prompt_attack: GuardrailChecksPromptAttackResult | None = None
    """The prompt attack check results."""

    sensitive_information: GuardrailChecksSensitiveInformationResult | None = None
    """The sensitive information check results."""

    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_RESULTS, self)

    def serialize_members(self, serializer: ShapeSerializer):
        if self.content_filter is not None:
            serializer.write_struct(
                _SCHEMA_GUARDRAIL_CHECKS_RESULTS.members["contentFilter"],
                self.content_filter,
            )

        if self.prompt_attack is not None:
            serializer.write_struct(
                _SCHEMA_GUARDRAIL_CHECKS_RESULTS.members["promptAttack"],
                self.prompt_attack,
            )

        if self.sensitive_information is not None:
            serializer.write_struct(
                _SCHEMA_GUARDRAIL_CHECKS_RESULTS.members["sensitiveInformation"],
                self.sensitive_information,
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["content_filter"] = (
                        GuardrailChecksContentFilterResult.deserialize(de)
                    )

                case 1:
                    kwargs["prompt_attack"] = (
                        GuardrailChecksPromptAttackResult.deserialize(de)
                    )

                case 2:
                    kwargs["sensitive_information"] = (
                        GuardrailChecksSensitiveInformationResult.deserialize(de)
                    )

                case _:
                    logger.debug("Unexpected member schema: %s", schema)

        deserializer.read_struct(_SCHEMA_GUARDRAIL_CHECKS_RESULTS, consumer=_consumer)
        return kwargs
...
class GuardrailChecksContentFilterUsage:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_USAGE, self)

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_integer(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_USAGE.members["textUnits"],
            self.text_units,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["text_units"] = de.read_integer(
                        _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_USAGE.members[
                            "textUnits"
                        ]
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_CONTENT_FILTER_USAGE, consumer=_consumer
        )
        if "text_units" not in kwargs:
            kwargs["text_units"] = 0
        return kwargs
...
class GuardrailChecksPromptAttackUsage:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_USAGE, self)

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_integer(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_USAGE.members["textUnits"],
            self.text_units,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["text_units"] = de.read_integer(
                        _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_USAGE.members[
                            "textUnits"
                        ]
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_PROMPT_ATTACK_USAGE, consumer=_consumer
        )
        if "text_units" not in kwargs:
            kwargs["text_units"] = 0
        return kwargs
...
class GuardrailChecksSensitiveInformationUsage:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_USAGE, self
        )

    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_integer(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_USAGE.members["textUnits"],
            self.text_units,
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["text_units"] = de.read_integer(
                        _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_USAGE.members[
                            "textUnits"
                        ]
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_SENSITIVE_INFORMATION_USAGE, consumer=_consumer
        )
        if "text_units" not in kwargs:
            kwargs["text_units"] = 0
        return kwargs
...
class GuardrailChecksUsageResults:
    ...
    def serialize(self, serializer: ShapeSerializer):
        serializer.write_struct(_SCHEMA_GUARDRAIL_CHECKS_USAGE_RESULTS, self)

    def serialize_members(self, serializer: ShapeSerializer):
        if self.content_filter is not None:
            serializer.write_struct(
                _SCHEMA_GUARDRAIL_CHECKS_USAGE_RESULTS.members["contentFilter"],
                self.content_filter,
            )

        if self.prompt_attack is not None:
            serializer.write_struct(
                _SCHEMA_GUARDRAIL_CHECKS_USAGE_RESULTS.members["promptAttack"],
                self.prompt_attack,
            )

        if self.sensitive_information is not None:
            serializer.write_struct(
                _SCHEMA_GUARDRAIL_CHECKS_USAGE_RESULTS.members["sensitiveInformation"],
                self.sensitive_information,
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["content_filter"] = (
                        GuardrailChecksContentFilterUsage.deserialize(de)
                    )

                case 1:
                    kwargs["prompt_attack"] = (
                        GuardrailChecksPromptAttackUsage.deserialize(de)
                    )

                case 2:
                    kwargs["sensitive_information"] = (
                        GuardrailChecksSensitiveInformationUsage.deserialize(de)
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_GUARDRAIL_CHECKS_USAGE_RESULTS, consumer=_consumer
        )
        return kwargs
...
@dataclass(kw_only=True)
class InvokeGuardrailChecksOutput:
    """Dataclass for InvokeGuardrailChecksOutput structure."""
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_INVOKE_GUARDRAIL_CHECKS_OUTPUT.members["results"], self.results
        )
        serializer.write_struct(
            _SCHEMA_INVOKE_GUARDRAIL_CHECKS_OUTPUT.members["usage"], self.usage
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["results"] = GuardrailChecksResults.deserialize(de)

                case 1:
                    kwargs["usage"] = GuardrailChecksUsageResults.deserialize(de)

                case _:
                    logger.debug("Unexpected member schema: %s", schema)

        deserializer.read_struct(
            _SCHEMA_INVOKE_GUARDRAIL_CHECKS_OUTPUT, consumer=_consumer
        )
        if "results" not in kwargs:
            kwargs["results"] = GuardrailChecksResults._smithy_default()
        if "usage" not in kwargs:
            kwargs["usage"] = GuardrailChecksUsageResults._smithy_default()
        return kwargs


INVOKE_GUARDRAIL_CHECKS = APIOperation(
    input=InvokeGuardrailChecksInput,
    output=InvokeGuardrailChecksOutput,
    schema=_SCHEMA_INVOKE_GUARDRAIL_CHECKS,
    input_schema=_SCHEMA_INVOKE_GUARDRAIL_CHECKS_INPUT,
    output_schema=_SCHEMA_INVOKE_GUARDRAIL_CHECKS_OUTPUT,
    error_registry=TypeRegistry(
        {
            ShapeID(
                "com.amazonaws.bedrockruntime#AccessDeniedException"
...
class GuardrailTrace(UnknownEnumMixin, StrEnum):
    ENABLED = "enabled"
    DISABLED = "disabled"
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 2:
                    kwargs["trace"] = GuardrailTrace(
                        de.read_string(_SCHEMA_GUARDRAIL_CONFIGURATION.members["trace"])
                    )
...
class AudioFormat(UnknownEnumMixin, StrEnum):
    MP3 = "mp3"
    OPUS = "opus"
    WAV = "wav"
    AAC = "aac"
...
class AudioBlock:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["format"] = AudioFormat(
                        de.read_string(_SCHEMA_AUDIO_BLOCK.members["format"])
                    )
        ...
        if "format" not in kwargs:
            kwargs["format"] = AudioFormat._corrected("")
        if "source" not in kwargs:
            kwargs["source"] = AudioSourceUnknown(tag="")
        return kwargs


class CacheTTL(UnknownEnumMixin, StrEnum):
...
class CachePointType(UnknownEnumMixin, StrEnum):
    DEFAULT = "default"
...
class CachePointBlock:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["type"] = CachePointType(
                        de.read_string(_SCHEMA_CACHE_POINT_BLOCK.members["type"])
                    )

                case 1:
                    kwargs["ttl"] = CacheTTL(
                        de.read_string(_SCHEMA_CACHE_POINT_BLOCK.members["ttl"])
                    )
        ...
        if "type" not in kwargs:
            kwargs["type"] = CachePointType._corrected("")
        return kwargs
...
class SearchResultLocation:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        if self.search_result_index is not None:
            serializer.write_integer(
                _SCHEMA_SEARCH_RESULT_LOCATION.members["searchResultIndex"],
                self.search_result_index,
            )

        if self.start is not None:
            serializer.write_integer(
                _SCHEMA_SEARCH_RESULT_LOCATION.members["start"], self.start
            )

        if self.end is not None:
            serializer.write_integer(
                _SCHEMA_SEARCH_RESULT_LOCATION.members["end"], self.end
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["search_result_index"] = de.read_integer(
                        _SCHEMA_SEARCH_RESULT_LOCATION.members["searchResultIndex"]
                    )

                case 1:
                    kwargs["start"] = de.read_integer(
                        _SCHEMA_SEARCH_RESULT_LOCATION.members["start"]
                    )

                case 2:
                    kwargs["end"] = de.read_integer(
                        _SCHEMA_SEARCH_RESULT_LOCATION.members["end"]
                    )

                case _:
                    logger.debug("Unexpected member schema: %s", schema)

        deserializer.read_struct(_SCHEMA_SEARCH_RESULT_LOCATION, consumer=_consumer)
        return kwargs
...
class CitationLocationSearchResultLocation:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_CITATION_LOCATION.members["searchResultLocation"], self.value
        )

    @classmethod
    def deserialize(cls, deserializer: ShapeDeserializer) -> Self:
        return cls(value=SearchResultLocation.deserialize(deserializer))
...
class _CitationLocationDeserializer:
    ...
    def _consumer(self, schema: Schema, de: ShapeDeserializer) -> None:
        match schema.expect_member_index():
            case 0:
                self._set_result(CitationLocationWeb.deserialize(de))
...
class Citation:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.source is not None:
            serializer.write_string(_SCHEMA_CITATION.members["source"], self.source)
            ...
            match schema.expect_member_index():
                ...
                case 1:
                    kwargs["source"] = de.read_string(
                        _SCHEMA_CITATION.members["source"]
                    )
...
class DocumentFormat(UnknownEnumMixin, StrEnum):
    PDF = "pdf"
    CSV = "csv"
    DOC = "doc"
    DOCX = "docx"
...
class DocumentBlock:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["format"] = DocumentFormat(
                        de.read_string(_SCHEMA_DOCUMENT_BLOCK.members["format"])
                    )
        ...
        if "name" not in kwargs:
            kwargs["name"] = ""
        if "source" not in kwargs:
            kwargs["source"] = DocumentSourceUnknown(tag="")
        return kwargs


class GuardrailConverseImageFormat(UnknownEnumMixin, StrEnum):
    PNG = "png"
    JPEG = "jpeg"
...
class GuardrailConverseImageBlock:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["format"] = GuardrailConverseImageFormat(
                        de.read_string(
        ...
        if "format" not in kwargs:
            kwargs["format"] = GuardrailConverseImageFormat._corrected("")
        if "source" not in kwargs:
            kwargs["source"] = GuardrailConverseImageSourceUnknown(tag="")
        return kwargs


class GuardrailConverseContentQualifier(UnknownEnumMixin, StrEnum):
    GROUNDING_SOURCE = "grounding_source"
    QUERY = "query"
    GUARD_CONTENT = "guard_content"
...
def _deserialize_guardrail_converse_content_qualifier_list(
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(
                GuardrailConverseContentQualifier(d.read_string(member_schema))
            )
...
class ImageFormat(UnknownEnumMixin, StrEnum):
    PNG = "png"
    JPEG = "jpeg"
    GIF = "gif"
    WEBP = "webp"
...
class ImageBlock:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["format"] = ImageFormat(
                        de.read_string(_SCHEMA_IMAGE_BLOCK.members["format"])
                    )
        ...
        if "format" not in kwargs:
            kwargs["format"] = ImageFormat._corrected("")
        if "source" not in kwargs:
            kwargs["source"] = ImageSourceUnknown(tag="")
        return kwargs
...
class SearchResultContentBlock:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(
            _SCHEMA_SEARCH_RESULT_CONTENT_BLOCK.members["text"], self.text
        )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["text"] = de.read_string(
                        _SCHEMA_SEARCH_RESULT_CONTENT_BLOCK.members["text"]
                    )
        ...
        deserializer.read_struct(
            _SCHEMA_SEARCH_RESULT_CONTENT_BLOCK, consumer=_consumer
        )
        if "text" not in kwargs:
            kwargs["text"] = ""
        return kwargs
...
def _serialize_search_result_content_blocks(
    serializer: ShapeSerializer, schema: Schema, value: list[SearchResultContentBlock]
) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
...
def _deserialize_search_result_content_blocks(
    deserializer: ShapeDeserializer, schema: Schema
) -> list[SearchResultContentBlock]:
    result: list[SearchResultContentBlock] = []
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(SearchResultContentBlock.deserialize(d))
...
class SearchResultBlock:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(
            _SCHEMA_SEARCH_RESULT_BLOCK.members["source"], self.source
        )
        serializer.write_string(
            _SCHEMA_SEARCH_RESULT_BLOCK.members["title"], self.title
        )
        _serialize_search_result_content_blocks(
            serializer, _SCHEMA_SEARCH_RESULT_BLOCK.members["content"], self.content
        )
        if self.citations is not None:
            serializer.write_struct(
                _SCHEMA_SEARCH_RESULT_BLOCK.members["citations"], self.citations
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["source"] = de.read_string(
                        _SCHEMA_SEARCH_RESULT_BLOCK.members["source"]
                    )

                case 1:
                    kwargs["title"] = de.read_string(
                        _SCHEMA_SEARCH_RESULT_BLOCK.members["title"]
                    )

                case 2:
                    kwargs["content"] = _deserialize_search_result_content_blocks(
                        de, _SCHEMA_SEARCH_RESULT_BLOCK.members["content"]
                    )
        ...
        deserializer.read_struct(_SCHEMA_SEARCH_RESULT_BLOCK, consumer=_consumer)
        if "source" not in kwargs:
            kwargs["source"] = ""
...
class VideoBlock:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["format"] = VideoFormat(
                        de.read_string(_SCHEMA_VIDEO_BLOCK.members["format"])
                    )
        ...
        if "format" not in kwargs:
            kwargs["format"] = VideoFormat._corrected("")
        if "source" not in kwargs:
            kwargs["source"] = VideoSourceUnknown(tag="")
        return kwargs
...
class ToolResultContentBlockSearchResult:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_TOOL_RESULT_CONTENT_BLOCK.members["searchResult"], self.value
        )

    @classmethod
    def deserialize(cls, deserializer: ShapeDeserializer) -> Self:
        return cls(value=SearchResultBlock.deserialize(deserializer))
...
class ToolResultStatus(UnknownEnumMixin, StrEnum):
    SUCCESS = "success"
    ERROR = "error"
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 2:
                    kwargs["status"] = ToolResultStatus(
                        de.read_string(_SCHEMA_TOOL_RESULT_BLOCK.members["status"])
                    )
...
class ToolUseType(UnknownEnumMixin, StrEnum):
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 3:
                    kwargs["type"] = ToolUseType(
                        de.read_string(_SCHEMA_TOOL_USE_BLOCK.members["type"])
                    )
...
class ContentBlockSearchResult:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_struct(
            _SCHEMA_CONTENT_BLOCK.members["searchResult"], self.value
        )
...
class Message:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["role"] = ConversationRole(
                        de.read_string(_SCHEMA_MESSAGE.members["role"])
                    )
        ...
        if "role" not in kwargs:
            kwargs["role"] = ConversationRole._corrected("")
        if "content" not in kwargs:
            kwargs["content"] = []
        return kwargs
...
class OutputFormatType(UnknownEnumMixin, StrEnum):
    """
...
class OutputFormat:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["type"] = OutputFormatType(
                        de.read_string(_SCHEMA_OUTPUT_FORMAT.members["type"])
                    )
        ...
        if "type" not in kwargs:
            kwargs["type"] = OutputFormatType._corrected("")
        if "structure" not in kwargs:
            kwargs["structure"] = OutputFormatStructureUnknown(tag="")
        return kwargs
...
class PerformanceConfigLatency(UnknownEnumMixin, StrEnum):
    STANDARD = "standard"
    OPTIMIZED = "optimized"
...
class PerformanceConfiguration:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["latency"] = PerformanceConfigLatency(
                        de.read_string(
...
class ServiceTierType(UnknownEnumMixin, StrEnum):
    PRIORITY = "priority"
    DEFAULT = "default"
    FLEX = "flex"
    RESERVED = "reserved"
...
class ServiceTier:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        serializer.write_string(_SCHEMA_SERVICE_TIER.members["type"], self.type)
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["type"] = ServiceTierType(
                        de.read_string(_SCHEMA_SERVICE_TIER.members["type"])
                    )

                case _:
                    logger.debug("Unexpected member schema: %s", schema)

        deserializer.read_struct(_SCHEMA_SERVICE_TIER, consumer=_consumer)
        if "type" not in kwargs:
            kwargs["type"] = ServiceTierType._corrected("")
        return kwargs
...
class ToolSpecification:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        if "input_schema" not in kwargs:
            kwargs["input_schema"] = ToolInputSchemaUnknown(tag="")
        return kwargs
...
class _ToolDeserializer:
    ...
    def _consumer(self, schema: Schema, de: ShapeDeserializer) -> None:
        match schema.expect_member_index():
            ...
            case 1:
                self._set_result(ToolSystemTool.deserialize(de))
...
class ConverseMetrics:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        if "latency_ms" not in kwargs:
            kwargs["latency_ms"] = 0
        return kwargs

    @classmethod
    def _smithy_default(cls) -> Self:
        return cls(latency_ms=0)
...
class StopReason(UnknownEnumMixin, StrEnum):
    END_TURN = "end_turn"
    TOOL_USE = "tool_use"
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["ttl"] = CacheTTL(
                        de.read_string(_SCHEMA_CACHE_DETAIL.members["ttl"])
                    )
        ...
        if "ttl" not in kwargs:
            kwargs["ttl"] = CacheTTL._corrected("")
...
class ConverseOperationOutput:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.service_tier is not None:
            serializer.write_struct(
                _SCHEMA_CONVERSE_OPERATION_OUTPUT.members["serviceTier"],
                self.service_tier,
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        if "output" not in kwargs:
            kwargs["output"] = ConverseOutputUnknown(tag="")
        if "stop_reason" not in kwargs:
            kwargs["stop_reason"] = StopReason._corrected("")
        if "usage" not in kwargs:
            kwargs["usage"] = TokenUsage._smithy_default()
        if "metrics" not in kwargs:
            kwargs["metrics"] = ConverseMetrics._smithy_default()
        return kwargs
...
class GuardrailStreamProcessingMode(UnknownEnumMixin, StrEnum):
    SYNC = "sync"
    ASYNC_ = "async"
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 3:
                    kwargs["stream_processing_mode"] = GuardrailStreamProcessingMode(
                        de.read_string(
                            _SCHEMA_GUARDRAIL_STREAM_CONFIGURATION.members[
...
class CitationsDelta:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.source is not None:
            serializer.write_string(
                _SCHEMA_CITATIONS_DELTA.members["source"], self.source
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 1:
                    kwargs["source"] = de.read_string(
                        _SCHEMA_CITATIONS_DELTA.members["source"]
                    )
...
class _ToolResultBlockDeltaDeserializer:
    _result: ToolResultBlockDelta | None = None

    def deserialize(self, deserializer: ShapeDeserializer) -> ToolResultBlockDelta:
        self._result = None
        deserializer.read_struct(_SCHEMA_TOOL_RESULT_BLOCK_DELTA, self._consumer)
...
def _serialize_tool_result_blocks_delta(
    serializer: ShapeSerializer, schema: Schema, value: list[ToolResultBlockDelta]
) -> None:
    member_schema = schema.members["member"]
    with serializer.begin_list(schema, len(value)) as ls:
        for e in value:
...
def _deserialize_tool_result_blocks_delta(
    deserializer: ShapeDeserializer, schema: Schema
) -> list[ToolResultBlockDelta]:
    result: list[ToolResultBlockDelta] = []
    ...
    def _read_value(d: ShapeDeserializer):
        if d.is_null():
            ...
            result.append(_ToolResultBlockDeltaDeserializer().deserialize(d))
...
class _ContentBlockDeltaDeserializer:
    ...
    def _consumer(self, schema: Schema, de: ShapeDeserializer) -> None:
        match schema.expect_member_index():
            ...
            case 2:
                self._set_result(ContentBlockDeltaToolResult.deserialize(de))
...
class ContentBlockDeltaEvent:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        if "delta" not in kwargs:
            kwargs["delta"] = ContentBlockDeltaUnknown(tag="")
        if "content_block_index" not in kwargs:
            kwargs["content_block_index"] = 0
        return kwargs
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["format"] = ImageFormat(
                        de.read_string(_SCHEMA_IMAGE_BLOCK_START.members["format"])
                    )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 2:
                    kwargs["type"] = ToolUseType(
                        de.read_string(_SCHEMA_TOOL_USE_BLOCK_START.members["type"])
                    )
...
class ContentBlockStartEvent:
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        if "start" not in kwargs:
            kwargs["start"] = ContentBlockStartUnknown(tag="")
        if "content_block_index" not in kwargs:
            kwargs["content_block_index"] = 0
        return kwargs
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["role"] = ConversationRole(
                        de.read_string(_SCHEMA_MESSAGE_START_EVENT.members["role"])
                    )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                case 0:
                    kwargs["stop_reason"] = StopReason(
                        de.read_string(_SCHEMA_MESSAGE_STOP_EVENT.members["stopReason"])
                    )
...
class ConverseStreamMetadataEvent:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.service_tier is not None:
            serializer.write_struct(
                _SCHEMA_CONVERSE_STREAM_METADATA_EVENT.members["serviceTier"],
                self.service_tier,
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        if "usage" not in kwargs:
            kwargs["usage"] = TokenUsage._smithy_default()
        if "metrics" not in kwargs:
            kwargs["metrics"] = ConverseStreamMetrics._smithy_default()
        return kwargs
...
class Trace(UnknownEnumMixin, StrEnum):
    ENABLED = "ENABLED"
    DISABLED = "DISABLED"
    ENABLED_FULL = "ENABLED_FULL"
...
class InvokeModelInput:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.service_tier is not None:
            serializer.write_string(
                _SCHEMA_INVOKE_MODEL_INPUT.members["serviceTier"], self.service_tier
            )

        if self.request_metadata is not None:
            serializer.write_string(
                _SCHEMA_INVOKE_MODEL_INPUT.members["requestMetadata"],
                self.request_metadata,
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 4:
                    kwargs["trace"] = Trace(
                        de.read_string(_SCHEMA_INVOKE_MODEL_INPUT.members["trace"])
                    )
                ...
                case 7:
                    kwargs["performance_config_latency"] = PerformanceConfigLatency(
                        de.read_string(
                            _SCHEMA_INVOKE_MODEL_INPUT.members[
                ...
                case 8:
                    kwargs["service_tier"] = ServiceTierType(
                        de.read_string(
                            _SCHEMA_INVOKE_MODEL_INPUT.members["serviceTier"]
                        )
                    )

                case 9:
                    kwargs["request_metadata"] = de.read_string(
                        _SCHEMA_INVOKE_MODEL_INPUT.members["requestMetadata"]
                    )
...
class InvokeModelOutput:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.service_tier is not None:
            serializer.write_string(
                _SCHEMA_INVOKE_MODEL_OUTPUT.members["serviceTier"], self.service_tier
            )
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 2:
                    kwargs["performance_config_latency"] = PerformanceConfigLatency(
                        de.read_string(
                            _SCHEMA_INVOKE_MODEL_OUTPUT.members[
                                "performanceConfigLatency"
                            ]
                        )
                    )
                ...
                case 3:
                    kwargs["service_tier"] = ServiceTierType(
                        de.read_string(
                            _SCHEMA_INVOKE_MODEL_OUTPUT.members["serviceTier"]
                        )
                    )
...
class InvokeModelWithResponseStreamInput:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.service_tier is not None:
            serializer.write_string(
                _SCHEMA_INVOKE_MODEL_WITH_RESPONSE_STREAM_INPUT.members["serviceTier"],
                self.service_tier,
            )
...
class InvokeModelWithResponseStreamOutput:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.service_tier is not None:
            serializer.write_string(
                _SCHEMA_INVOKE_MODEL_WITH_RESPONSE_STREAM_OUTPUT.members["serviceTier"],
                self.service_tier,
            )
...
class ConverseTokensRequest:
    ...
    def serialize_members(self, serializer: ShapeSerializer):
        ...
        if self.tool_config is not None:
            serializer.write_struct(
                _SCHEMA_CONVERSE_TOKENS_REQUEST.members["toolConfig"], self.tool_config
            )

        if self.additional_model_request_fields is not None:
            serializer.write_document(
                _SCHEMA_CONVERSE_TOKENS_REQUEST.members["additionalModelRequestFields"],
                self.additional_model_request_fields,
            )
    ...
    def deserialize_kwargs(cls, deserializer: ShapeDeserializer) -> dict[str, Any]:
        ...
        def _consumer(schema: Schema, de: ShapeDeserializer) -> None:
            match schema.expect_member_index():
                ...
                case 3:
                    kwargs["additional_model_request_fields"] = de.read_document(
                        _SCHEMA_CONVERSE_TOKENS_REQUEST.members[
                            "additionalModelRequestFields"
                        ]
                    )
