# Amazon Simple Queue Service Client

The `aws-sdk-sqs` package provides a client for making
...
- [API Reference](https://docs.aws.amazon.com/sdk-for-python/v1/reference/clients/sqs/) -
  the SQS client, available operations, and types.
