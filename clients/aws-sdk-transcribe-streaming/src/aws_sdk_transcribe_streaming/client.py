...
class TranscribeStreamingClient:
    ...
    **Health Scribe**.
    ...
    async def start_call_analytics_stream_transcription(
        ...
        Args:
            input (StartCallAnalyticsStreamTranscriptionInput): The operation's input.
            plugins (list[Plugin] | None): A list of callables that modify the configuration dynamically.
                Changes made by these plugins only apply for the duration of the operation
                execution and will not affect any other operation invocations.

        Returns:
            StartCallAnalyticsStreamTranscriptionOutput: The operation's output.
        """
    ...
    async def start_medical_scribe_stream(
        ...
        Args:
            input (StartMedicalScribeStreamInput): The operation's input.
            plugins (list[Plugin] | None): A list of callables that modify the configuration dynamically.
                Changes made by these plugins only apply for the duration of the operation
                execution and will not affect any other operation invocations.

        Returns:
            StartMedicalScribeStreamOutput: The operation's output.
        """
    ...
    async def start_medical_stream_transcription(
        ...
        Args:
            input (StartMedicalStreamTranscriptionInput): The operation's input.
            plugins (list[Plugin] | None): A list of callables that modify the configuration dynamically.
                Changes made by these plugins only apply for the duration of the operation
                execution and will not affect any other operation invocations.

        Returns:
            StartMedicalStreamTranscriptionOutput: The operation's output.
        """
    ...
    async def start_stream_transcription(
        ...
        Args:
            input (StartStreamTranscriptionInput): The operation's input.
            plugins (list[Plugin] | None): A list of callables that modify the configuration dynamically.
                Changes made by these plugins only apply for the duration of the operation
                execution and will not affect any other operation invocations.

        Returns:
            StartStreamTranscriptionOutput: The operation's output.
        """
