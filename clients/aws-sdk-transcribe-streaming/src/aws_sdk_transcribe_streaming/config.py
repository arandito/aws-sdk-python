...
class Config:
    ...
    def __init__(
        ...
        *,
        ...
        self.endpoint_resolver = endpoint_resolver or _RegionalResolver(endpoint_prefix="transcribestreaming")
